...
def api_all_brokers_account_state(request):
    ...
    Returns JSON with account information for IG and MEXC SPOT brokers:
    - ig: IG broker account state (if configured and connected)
    - mexc: MEXC SPOT broker account state (if configured and connected)
    ...
    # Try to get MEXC SPOT account state
    try:
