...
INSTALLED_APPS = [
    'core',  # Must be before jazzmin to override template tags for Django 6.0 compatibility
    'jazzmin',
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Fiona v1.0 Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Fiona v1.0 Admin",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Fiona v1.0 Admin",
    ...
    "welcome_sign": "Welcome to the Fioan",

    # Copyright on the footer
    "copyright": "Christian Angermeier",
